  ...
  return knex('activities').del()
    .then(function () {
      ...
      return knex('activities').insert([
        {
          id: 1,
          title: 'Go Biking at Makara Peak Bike Park?',
      ...
      },
      {
          ...
          img: 'https://cdn-media-1.freecodecamp.org/images/OC1z0BMnwot2dpGpdw8nLeE7KV299yL8FuAD',
          intensity: 'high'
      },
      {
          id: 3,
      ...
      {
          id: 4,
          title: 'Throw Axes at Sweet Axe Throwing Co.?',
      ...
      {
          id: 8,
          title: 'Watch a Movie at Lighthouse Cinema?',
